...
import { ThinkingIndicator, StreamingMessage } from '../components/StreamingComponents';
        ...
        <div className="top-bar">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={useStreaming ? "Modo streaming ativo" : "Modo tradicional ativo"}
            >
              {useStreaming ? '🌊' : '📄'} {useStreaming ? 'Stream' : 'Normal'}
            </button>
        ...
        {!isChatMode && messages.length === 0 ? (
          ...
          <>
            <div className="messages-area">
              ...
              {/* Messages with enhanced context display and streaming support */}
              <div className="space-y-4">
                {messages.map((message) => (
                  message.isStreaming || message.isComplete !== undefined ? (
                    // Usar StreamingMessage para mensagens que suportam streaming
                    <StreamingMessage
                      key={message.id}
                      text={message.text}
                    ...
                    // Usar EnhancedMessage para mensagens tradicionais
              ...
              {/* Thinking Indicator para streaming */}
              <ThinkingIndicator 
                isVisible={isLoading && useStreaming} 
                message="O assistente está a pensar"
              />

              {/* Typing Indicator tradicional */}
